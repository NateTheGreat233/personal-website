...
const ContactButton = ({altColor}: {altColor: boolean}): JSX.Element => {
    ...
    return (
        <Box>
            ...
            >
                <Box sx={{ display: 'flex', flexDirection: 'column', width: isDesktop ? 400 : 300, height: isDesktop ? 400 : 300, backgroundColor: 'black', borderRadius: 20, padding: 40, alignItems: 'center', border: 1}}>
